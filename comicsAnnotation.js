...
if (annotationType == "Background and Location") {
    ...
    db.collection("Background_Experiment2").get().then((snapshot) => {
...
function sendDataToFireBase(event) {
    ...
    db.collection("Background_Experiment2").add({time: Date().toLocaleString(),
                              jsonData: jsonString}
...
function nextStory(event) {
    ...
    location.href = 'https://app.prolific.co/submissions/complete?cc=2BD27914'; // go back to prolific
}
